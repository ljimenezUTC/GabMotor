...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
		...
		<ul class="navbar-nav mr-auto mt-2 mt-md-0">
			...
			<li class="nav-item active" <?php if($uri == 'inicio') echo "class='active'"; ?>>
				<a class="nav-link" href="inicio" >Inicio <span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item" <?php if($uri == 'clientes') echo "class='active'"; ?>>
				<a class="nav-link" href="clientes" >Clientes</a>
			</li>
			<li class="nav-item" <?php if($uri == 'vehiculos') echo "class='active'"; ?>>
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Su Cuenta<b class="caret"></b></a>
						...
						<div class="navbar-footer-content">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<a href="salir" class="close">Salir</a>
